...
| [ ] | #0121 | [Best Time to Buy and Sell Stock](https://leetcode.com/problems/best-time-to-buy-and-sell-stock/) | Easy | Sliding Window / Greedy | [Solution](01-array/0121_best_time_to_buy_and_sell_stock.md) | |
...
| [ ] | #0191 | [Number of 1 Bits](https://leetcode.com/problems/number-of-1-bits/) | Easy | Brian Kernighan (`n & (n - 1)`) | [Solution](02-binary/0191_number_of_1_bits.md) | |
| [ ] | #0338 | [Counting Bits](https://leetcode.com/problems/counting-bits/) | Easy | DP + Bit Manipulation | [Solution](02-binary/0338_counting_bits.md) | |
| [ ] | #0268 | [Missing Number](https://leetcode.com/problems/missing-number/) | Easy | XOR / Gauss Sum Formula | [Solution](02-binary/0268_missing_number.md) | |
...
| Status | ID | Tên bài | Difficulty | Pattern / Key Technique | Solution | Ghi chú |
| :---: | :---: | :--- | :---: | :--- | :---: | :--- |
| [ ] | #0206 | [Reverse Linked List](https://leetcode.com/problems/reverse-linked-list/) | Easy | Iterative (3 Pointers) / Recursive | [Solution](06-linked-list/0206_reverse_linked_list.md) | |
...
| Status | ID | Tên bài | Difficulty | Pattern / Key Technique | Solution | Ghi chú |
| :---: | :---: | :--- | :---: | :--- | :---: | :--- |
| [ ] | #0104 | [Maximum Depth of Binary Tree](https://leetcode.com/problems/maximum-depth-of-binary-tree/) | Easy | DFS / BFS Level Order | [Solution](09-tree/0104_maximum_depth_of_binary_tree.md) | |
